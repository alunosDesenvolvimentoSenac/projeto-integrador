...
export default function DashboardView() {
  ...
  const validateLabSelection = () => {
    if (!selectedLab || selectedLab === "0") {
        setIsLabError(true);
        toast.error("Selecione um laboratório", { description: "É necessário escolher uma sala para visualizar a agenda.", duration: 4000, icon: <FlaskConical className="h-5 w-5 text-red-500" /> });
        return false;
    }
    return true;
  }
      ...
      <SidebarInset className="bg-[#F8F9FA] dark:bg-zinc-950 flex flex-col flex-1 h-full overflow-hidden">
        <header className="flex h-14 shrink-0 items-center gap-2 border-b bg-background px-4 sticky top-0 z-20">
          <div className="flex items-center gap-2">
            ...
            <Breadcrumb><BreadcrumbList><BreadcrumbItem className="hidden md:block"><BreadcrumbLink href="#">Agendamento</BreadcrumbLink></BreadcrumbItem><BreadcrumbSeparator className="hidden md:block" /><BreadcrumbItem><BreadcrumbPage>Visão Geral</BreadcrumbPage></BreadcrumbItem></BreadcrumbList></Breadcrumb>
          </div>
